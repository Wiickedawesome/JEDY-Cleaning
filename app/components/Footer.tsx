    ...
    <footer className="bg-brown-800 text-cream-50 py-12 mt-20">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-xl font-bold mb-4 text-pink-300">JEDY Cleaning Services</h3>
          ...
          <div>
            <h4 className="font-bold mb-4 text-pink-300">Services</h4>
            <ul className="space-y-2 text-cream-100">
              <li>
                <Link href="/services" className="hover:text-pink-300 transition-colors">
                  Weekly Cleaning
                </Link>
              </li>
              <li>
          ...
          <div>
            <h4 className="font-bold mb-4 text-pink-300">Company</h4>
            <ul className="space-y-2 text-cream-100">
              <li>
          ...
          <div>
            <h4 className="font-bold mb-4 text-pink-300">Contact</h4>
            <p className="text-cream-100 mb-2">
              <a href="mailto:jedycleaning@gmail.com" className="hover:text-pink-300 transition-colors">
                jedycleaning@gmail.com
              </a>
            </p>
            <p className="text-cream-100">
              <a href="tel:8653332637" className="hover:text-pink-300 transition-colors">
                (865) 333-2637
              </a>
            </p>
          </div>
